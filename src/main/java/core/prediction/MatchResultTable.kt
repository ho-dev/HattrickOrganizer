...
class MatchResultTable extends JTable {
	...
	private void initModel(MatchResult matchresults,boolean isHome) {
		...
		final TableColumnModel tableColumnModel = getColumnModel();
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(0)).setPreferredWidth(core.util.Helper.calcCellWidth(100));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(0)).setMaxWidth(core.util.Helper.calcCellWidth(100));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(1)).setPreferredWidth(core.util.Helper.calcCellWidth(250));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(1)).setMaxWidth(core.util.Helper.calcCellWidth(250));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(2)).setMaxWidth(core.util.Helper.calcCellWidth(100));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(2)).setPreferredWidth(core.util.Helper.calcCellWidth(100));
