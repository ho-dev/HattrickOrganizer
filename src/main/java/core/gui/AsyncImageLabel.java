...
public class AsyncImageLabel extends JLabel {
    ...
    public void load(ImageProvider imageProvider) {
        load(imageProvider, false);
    }

    public void reload(ImageProvider imageProvider) {
        load(imageProvider, true);
    }

    private void load(ImageProvider imageProvider, boolean forceReload) {
