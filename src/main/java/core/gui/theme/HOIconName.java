...
public interface HOIconName {
	 ...
	 String IMAGEPANEL_BACKGROUND = "imagePanel.background";
	 String GRASSPANEL_BACKGROUND = "grassPanel.background";
	 String RATINGCOMPARISON_BACKGROUND = "ratingComparison.background";
	 ...
	 String WEATHER_SUN_NEG 	= "weather.sun.neg";
	...
	String RED_WHITE_CLOCK = "red-white-clock";
	String WHITE_RED_CLOCK = "white-red-clock";
