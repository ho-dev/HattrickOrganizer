...
final class ScoutTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[]{
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("baseWage").setGetter((o) -> ((ScoutEintrag) o).getbaseWage()).setSetter((o, v) -> ((ScoutEintrag) o).setbaseWage(new AmountOfMoney((int) v))).setType(Types.INTEGER).isNullable(false).build(),
