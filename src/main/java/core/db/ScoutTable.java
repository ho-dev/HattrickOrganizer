...
final class ScoutTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[]{
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("Price").setGetter((o) -> ((ScoutEintrag) o).getPrice()).setSetter((o, v) -> ((ScoutEintrag) o).setPrice(new AmountOfMoney((int) v))).setType(Types.INTEGER).isNullable(false).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("baseWage").setGetter((o) -> ((ScoutEintrag) o).getbaseWage().getSwedishKrona()).setSetter((o, v) -> ((ScoutEintrag) o).setbaseWage(new AmountOfMoney((long) v))).setType(Types.INTEGER).isNullable(false).build(),
