...
public final class TournamentDetailsTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[]{
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("Season").setGetter((p) -> ((TournamentDetails) p).getSeason()).setSetter((p, v) -> ((TournamentDetails) p).setSeason((short) (int) v)).setType(Types.SMALLINT).isNullable(false).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("LastMatchRound").setGetter((p) -> ((TournamentDetails) p).getLastMatchRound()).setSetter((p, v) -> ((TournamentDetails) p).setLastMatchRound((short) (int) v)).setType(Types.TINYINT).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("FirstMatchRoundDate").setGetter((p) -> ((TournamentDetails) p).getFirstMatchRoundDate()).setSetter((p, v) -> ((TournamentDetails) p).setFirstMatchRoundDate((HODateTime) v)).setType(Types.TIMESTAMP).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("NextMatchRoundDate").setGetter((p) -> ((TournamentDetails) p).getNextMatchRoundDate()).setSetter((p, v) -> ((TournamentDetails) p).setNextMatchRoundDate((HODateTime) v)).setType(Types.TIMESTAMP).isNullable(true).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("Creator_UserID").setGetter((p) -> ((TournamentDetails) p).getCreator_UserId()).setSetter((p, v) -> ((TournamentDetails) p).setCreator_UserId((int) v)).setType(Types.INTEGER).isNullable(false).build(),
