...
public class YouthPlayerTable  extends AbstractTable {
    ...
    protected void initColumns() {
        var tmp = new ArrayList<>(List.of(
                ...
                ColumnDescriptor.Builder.newInstance().setColumnName("PlayerCategoryID").setGetter((p) -> (PlayerCategory.idOf(((YouthPlayer) p).getPlayerCategory()))).setSetter((p, v) -> ((YouthPlayer) p).setPlayerCategory(PlayerCategory.fromId((Integer) v))).setType(Types.INTEGER).isNullable(true).build(),
