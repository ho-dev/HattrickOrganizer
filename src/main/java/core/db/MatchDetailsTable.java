...
final class MatchDetailsTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[] {
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("RegionID").setGetter((o) -> ((Matchdetails) o).getRegionId()).setSetter((o, v) -> ((Matchdetails) o).setRegionId((int) v)).setType(Types.INTEGER).isNullable(false).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("RatingIndirectSetPiecesDef").setGetter((o) -> ((Matchdetails) o).getRatingIndirectSetPiecesDef()).setSetter((o, v) -> ((Matchdetails) o).setRatingIndirectSetPiecesDef((Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("RatingIndirectSetPiecesAtt").setGetter((o) -> ((Matchdetails) o).getRatingIndirectSetPiecesAtt()).setSetter((o, v) -> ((Matchdetails) o).setRatingIndirectSetPiecesAtt((Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeGoal0").setGetter((o) -> ((Matchdetails) o).getHomeGoalsInPart(MatchEvent.MatchPartId.BEFORE_THE_MATCH_STARTED)).setSetter((o, v) -> ((Matchdetails) o).setHomeGoalsInPart(MatchEvent.MatchPartId.BEFORE_THE_MATCH_STARTED, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeGoal1").setGetter((o) -> ((Matchdetails) o).getHomeGoalsInPart(MatchEvent.MatchPartId.FIRST_HALF)).setSetter((o, v) -> ((Matchdetails) o).setHomeGoalsInPart(MatchEvent.MatchPartId.FIRST_HALF, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeGoal2").setGetter((o) -> ((Matchdetails) o).getHomeGoalsInPart(MatchEvent.MatchPartId.SECOND_HALF)).setSetter((o, v) -> ((Matchdetails) o).setHomeGoalsInPart(MatchEvent.MatchPartId.SECOND_HALF, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeGoal3").setGetter((o) -> ((Matchdetails) o).getHomeGoalsInPart(MatchEvent.MatchPartId.OVERTIME)).setSetter((o, v) -> ((Matchdetails) o).setHomeGoalsInPart(MatchEvent.MatchPartId.OVERTIME, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeGoal4").setGetter((o) -> ((Matchdetails) o).getHomeGoalsInPart(MatchEvent.MatchPartId.PENALTY_CONTEST)).setSetter((o, v) -> ((Matchdetails) o).setHomeGoalsInPart(MatchEvent.MatchPartId.PENALTY_CONTEST, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("GuestGoal1").setGetter((o) -> ((Matchdetails) o).getGuestGoalsInPart(MatchEvent.MatchPartId.FIRST_HALF)).setSetter((o, v) -> ((Matchdetails) o).setGuestGoalsInPart(MatchEvent.MatchPartId.FIRST_HALF, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("GuestGoal2").setGetter((o) -> ((Matchdetails) o).getGuestGoalsInPart(MatchEvent.MatchPartId.SECOND_HALF)).setSetter((o, v) -> ((Matchdetails) o).setGuestGoalsInPart(MatchEvent.MatchPartId.SECOND_HALF, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("GuestGoal3").setGetter((o) -> ((Matchdetails) o).getGuestGoalsInPart(MatchEvent.MatchPartId.OVERTIME)).setSetter((o, v) -> ((Matchdetails) o).setGuestGoalsInPart(MatchEvent.MatchPartId.OVERTIME, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("GuestGoal4").setGetter((o) -> ((Matchdetails) o).getGuestGoalsInPart(MatchEvent.MatchPartId.PENALTY_CONTEST)).setSetter((o, v) -> ((Matchdetails) o).setGuestGoalsInPart(MatchEvent.MatchPartId.PENALTY_CONTEST, (Integer) v)).setType(Types.INTEGER).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("HomeFormation").setGetter((o) -> ((Matchdetails) o).getFormation(true)).setSetter((o, v) -> ((Matchdetails) o).setHomeFormation((String) v)).setType(Types.VARCHAR).setLength(5).isNullable(false).build(),
				ColumnDescriptor.Builder.newInstance().setColumnName("AwayFormation").setGetter((o) -> ((Matchdetails) o).getFormation(false)).setSetter((o, v) -> ((Matchdetails) o).setAwayFormation((String) v)).setType(Types.VARCHAR).setLength(5).isNullable(false).build()
		};
	}
