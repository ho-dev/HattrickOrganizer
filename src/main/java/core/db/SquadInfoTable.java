...
public class SquadInfoTable extends AbstractTable {
    ...
    protected void initColumns() {
        columns = new ColumnDescriptor[]{
                ...
                ColumnDescriptor.Builder.newInstance().setColumnName("SALARY").setGetter((p) -> ((SquadInfo) p).getSalarySum()).setSetter((p, v) -> ((SquadInfo) p).setSalarySum(new AmountOfMoney((int) v))).setType(Types.INTEGER).isNullable(false).build(),
