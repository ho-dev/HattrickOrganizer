...
internal class NtTeamTable(adapter: JDBCAdapter) : AbstractTable(TABLENAME, adapter) {
    override fun initColumns() {
        columns = arrayOf(
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("TEAM_ID")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("MORALE")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("SELFCONFIDENCE")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("xp253")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp343")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp352")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp433")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp442")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp451")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp523")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp532")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp541")
                ...
                .setType(Types.INTEGER).isNullable(false).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("xp550")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("SHORTNAME")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("COACHID")
                ...
                .setType(Types.INTEGER).isNullable(true).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("COACHNAME")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("LEAGUEID")
                ...
                .setType(Types.INTEGER).isNullable(true).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("LEAGUENAME")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("SUPPORTERPOPULARITY")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("FANCLUBSIZE")
            ...
            ColumnDescriptor.Builder.newInstance().setColumnName("RANK")
                ...
                .setType(Types.INTEGER).isNullable(true).build(),
            ColumnDescriptor.Builder.newInstance().setColumnName("FETCHEDDATE")
    ...
    protected override val constraintStatements: Array<String?>
        get() = arrayOf("  PRIMARY KEY (HRF_ID, TEAM_ID)")
