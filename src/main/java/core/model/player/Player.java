        ...
        if (wt != null) {
            try {
                ...
                for (var match : matches) {
                    ...
                    MatchLineupTeam mlt = DBManager.instance().getMatchLineupTeam(match.getMatchType().getSourceSystem().getValue(), match.getMatchID(), myID);
                ...
                if  ( this.getNationalTeamID() != 0 && this.getNationalTeamID() != myID){
                    ...
                    for (var match : nationalMatches){
                        MatchLineupTeam mlt = DBManager.instance().getMatchLineupTeam(match.getMatchType().getSourceSystem().getValue(), match.getMatchID(), this.getNationalTeamID());
