...
public class RecapPanelTableModel extends HOTableModel {
    ...
    private IHOTableCellEntry createIntegerTableEntry(Integer ival, Color color4Matchtyp) {
        return createIntegerTableEntry(ival, color4Matchtyp, false);
    }
    private IHOTableCellEntry createIntegerTableEntry(Integer ival, Color color4Matchtyp, boolean isCurrency) {
        double dval;
        String text;
        if ( ival != null){
