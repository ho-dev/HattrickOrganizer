...
public class DividerListener implements PropertyChangeListener {
	...
	public static final int teamAnalyzer_LowerLeftSplitPane = 7;
	public static final int teamAnalyzer_MiddleLeftSplitPane = 8;
	public static final int teamAnalyzer_UpperLeftSplitPane = 9;
	public static final int teamAnalyzer_MainSplitPane = 10;
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		case training_lowerLeftSplitPane:
			...
			break;
		case teamAnalyzer_LowerLeftSplitPane:
			UserParameter.instance().teamAnalyzer_LowerLeftSplitPane = newDivLoc;
			break;
		case teamAnalyzer_MiddleLeftSplitPane:
			UserParameter.instance().teamAnalyzer_MiddleLeftSplitPane = newDivLoc;
			break;
