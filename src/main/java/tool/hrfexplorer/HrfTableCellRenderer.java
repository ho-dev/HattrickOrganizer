...
public class HrfTableCellRenderer extends JLabel implements TableCellRenderer {
    private final Color grau = new Color(240, 240, 240);
    private final Color dunkelgrau = new Color(200, 200, 200);
    private final Color rot = new Color(254, 200, 200);
    private final Color hellblau = new Color(235, 235, 254);
    private final Color dunkelblau = new Color(220, 220, 254);
    private final Color gruen = new Color(220, 255, 220);
    private final Color mittelgruen = new Color(70, 200, 70);
    private final Color dunkelgruen = new Color(11, 148, 4);
    private final Color helltuerkis = new Color(53, 221, 241);
    private final Color dunkeltuerkis = new Color(37, 165, 180);
    private final Color gelb = new Color(254, 213, 90);
    private final Color weiss = new Color(254, 254, 254);
        ...
        if ((table.getName()).equals("calendar")) {
            ...
            if (column == 0) {
                ...
                if (value.toString().equals(" ")) {
                    ...
                    if (HrfExplorer.hrfForDay(Integer.parseInt(value.toString()))) {
                    ...
                    if (HrfExplorer.isSpecialEvent(Integer.parseInt(value.toString()))) {
