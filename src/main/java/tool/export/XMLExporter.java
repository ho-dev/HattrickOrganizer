		...
		try {
			...
			for (ExportMatchData matchData : matches) {
				...
				for (var p : lineupTeam.getLineup().getAllPositions()) {
					...
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getSpecialty())));
					...
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getAge())));
					...
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getGoalkeeperSkill())));
					ele = doc.createElement("Verteidigung");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getDefendingSkill())));
					ele = doc.createElement("Passspiel");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getPassingSkill())));
					ele = doc.createElement("Fluegel");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getWingerSkill())));
					ele = doc.createElement("Torschuss");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getScoringSkill())));
					ele = doc.createElement("Standards");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getSetPiecesSkill())));
					ele = doc.createElement("Spielaufbau");
					tmpEle.appendChild(ele);
					ele.appendChild(doc.createTextNode(String.valueOf(playerData.getPlaymakingSkill())));
