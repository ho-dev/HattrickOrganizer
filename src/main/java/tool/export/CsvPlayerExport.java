		...
		try {
			...
			while (iter.hasNext()) {
				...
				String [] outCols = {
						...
						df3.format(curPlayer.getGKskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.KEEPER)),
						df3.format(curPlayer.getDEFskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.DEFENDING)),
						df3.format(curPlayer.getWIskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.WINGER)),
						df3.format(curPlayer.getPMskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.PLAYMAKING)),
						df3.format(curPlayer.getPSskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.PASSING)),
						df3.format(curPlayer.getSCskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.SCORING)),
						df3.format(curPlayer.getSPskill() + curPlayer.getSubskill4PosAccurate(PlayerSkill.SET_PIECES)),
						// ls.player.position_short
