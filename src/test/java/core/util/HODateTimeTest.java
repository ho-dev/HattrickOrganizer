...
class HODateTimeTest {
    ...
    private static Stream<Arguments> testEpochSeconds() {
        return Stream.of(
            ...
            Arguments.of("2022-02-19 23:11:00", 1645308660L),
            Arguments.of("2021-02-14 23:11:00", 1613340660L),
            Arguments.of("2020-06-27 00:00:00", 1593208800L),
            Arguments.of("2018-05-10 00:00:00", 1525903200L),
            Arguments.of("2009-05-28 00:00:00", 1243461600L),
            Arguments.of("2020-09-07 00:00:00", 1599429600L),
            Arguments.of("2020-09-14 00:00:00", 1600034400L),
            Arguments.of("2020-09-21 01:30:00", 1600644600L)
        );
    }

    @ParameterizedTest
    @MethodSource
    void testEpochSeconds(String date, long epochSeconds) {
        var dti = HODateTime.fromHT(date);
        assertThat(HODateTime.toEpochSecond(dti)).isEqualTo(epochSeconds);
        assertThat(HODateTime.fromEpochSecond(epochSeconds)).isEqualTo(dti);
    }
